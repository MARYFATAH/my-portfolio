  ...
  return (
    <div className="h-[70vh] flex flex-col bg-gray-100">
      ...
      <div className="w-full max-w-8xl mx-auto flex flex-col md:flex-row items-start justify-between p-6 bg-white shadow-md hover:shadow-lg transition-all duration-300 ease-in-out min-h-[70vh] relative">
        {/* Text Section */}
        <div className="sm:w-full md:w-[700px] p-6 md:mt-20 md:text-start sm:text-center sm:mt-0 flex flex-col justify-center">
          ...
          <h3 className="text-lg md:text-xl font-[Montserrat] mt-6 text-gray-600 hover:text-3xl transition-all duration-500">
        ...
        <Link
          to="/bio"
          className="text-lg md:text-xl font-[Montserrat] absolute bottom-10 left-10 text-gray-800 px-4 py-2 hover:border-b-2 border-gray-800 transition-colors duration-300"
        >
          Read My Bio
        </Link>
      </div>
